...
model  = tf.keras.models.load_model('model_X_ray_clavicle_mask.h5')
model.summary()
...
orig_size_out_path = output_path + "Original_Size/clavicle_masked_image/"
resized_out_path = output_path + "128x128/clavicle_masked_image/"

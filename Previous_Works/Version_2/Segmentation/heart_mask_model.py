...
NAME = "heart_mask-{}".format(int(time.time()))
...
Train_Y_path = DATA_TRAIN + "Masks/Heart/"
...
callbacks = [
    ...
    tf.keras.callbacks.ModelCheckpoint('model_X_ray_heart_mask.h5', verbose=1, save_best_only=True)]

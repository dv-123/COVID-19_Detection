...
NAME = "test_4-{}".format(int(time.time()))
...
callbacks = [
    ...
    tf.keras.callbacks.ModelCheckpoint('test_model_4.h5', save_best_only=True)]

custom_vgg_model.fit(X_train, y_train, batch_size=10, epochs=20, verbose=1, validation_data = (X_test, y_test), callbacks=callbacks)

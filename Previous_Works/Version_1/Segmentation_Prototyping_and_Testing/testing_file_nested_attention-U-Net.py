...
model  = tf.keras.models.load_model('model_D2_for_Covid-19_Nested_attention_U_net.h5')
model.summary()
...
# this network performed better than attention u-net but not as much better as others
# reason can be the low availability of dataset for such big network, as it was in the attention net also.

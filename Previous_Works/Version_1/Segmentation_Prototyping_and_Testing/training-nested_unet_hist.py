...
NAME = "Nested-U_D1-Net_CNN_hist-{}".format(int(time.time()))
...
callbacks = [
    ...
    tf.keras.callbacks.ModelCheckpoint('model_D1_for_Covid-19_Nested_U_net_hist.h5', verbose=1, save_best_only=True)]

...
## model_D1_for_Covid-19_U_net.h5 is more relaible
...
model  = tf.keras.models.load_model('model_D2_for_Covid-19_U_net.h5')
model.summary()
...
# performs good but not as goog as nested U-net

...
NAME = "D1_lung-mask-{}".format(int(time.time()))
...
Train_Y_path = DATA_TRAIN + "lung_mask/"
...
callbacks = [
    ...
    tf.keras.callbacks.ModelCheckpoint('model_lung_mask.h5', verbose=1, save_best_only=True)]

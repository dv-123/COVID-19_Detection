...
def main(argv):
    inputfile = 'F:\\Major Project\\Datasets\\covid19-ct-scans\\ct_scans\\coronacases_org_001.nii'
    outputfile = 'F:\\Major Project\\preperations\\working with nii image format\\dataset\\ct_scans\\output_1_corona\\'
    try:
